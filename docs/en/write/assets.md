...
Over that reports `EMB-401`, and the hint is concrete: compress it first (for PNG try `pngquant --quality=70`), or draw it as SVG with a [diagram fence](/en/write/diagrams/).
