...
这张表**是主题清单本身生成的**，不是照着抄的第二份：每一行的说明就是 `DOC-106` 诊断里印出来的那一句（[ADR-0047](https://github.com/lazygophers/pamphlet/blob/master/docs/adr/0047-theme-label-is-bilingual-data.md)）。
